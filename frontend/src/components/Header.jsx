import { Moon, Sun, User, Home, PawPrint, Store, Stethoscope, Sparkles } from "lucide-react";
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#8657ff] dark:bg-[#8657ff] shadow-md transition-colors duration-300">
        <div className="container mx-auto flex justify-between items-center px-4 py-4 md:px-10 lg:px-48">
          ...
          <div className="flex gap-4 md:gap-8">
            ...
            <button onClick={() => handleNavigation("/conseil-ai")} aria-label="Conseil IA">
              <Sparkles className="w-6 h-6 text-white hover:text-purple-300 transition-colors duration-300" />
            </button>
          </div>

          <div className="flex items-center gap-2">
            <NotificationPanel enabled={loggedIn} />
            <button
              type="button"
